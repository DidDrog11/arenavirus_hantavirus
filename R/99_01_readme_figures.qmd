...
ggsave(here("output", "plot_arena_prev.png"), plot = plot_arena_prev, width = 20, height = 10, dpi = 300)
ggsave(here("output", "plot_hanta_prev.png"), plot = plot_hanta_prev, width = 20, height = 10, dpi = 300)
```
...
ggsave(here("output", "hanta_temporal_plot.png"), plot = hanta_temporal_plot, width = 10, height = 6, dpi = 300)
ggsave(here("output", "arena_temporal_plot.png"), plot = arena_temporal_plot, width = 10, height = 6, dpi = 300)
temporal_plot
```
